import { ArrowRight, LineChart, Plus, RefreshCw, Search, Trash2, Wifi, WifiOff } from "lucide-react";
  ...
  return (
    <main className="app-shell">
      <header className="topbar">
        ...
        <Link className="etf-nav-link" to="/etf-returns">
